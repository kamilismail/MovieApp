...
public class RatingsRecyclerViewAdapter extends RecyclerView.Adapter {
    private ArrayList<FavouritesDTO> favList;

    private RecyclerView mRecyclerView;
    private RatingsFragment.SendArgumentsAndLaunchFragment mCallback;
    ...
    public RatingsRecyclerViewAdapter(ArrayList<FavouritesDTO> nowPlayingDTOList, RecyclerView _recyclerView, RatingsFragment.SendArgumentsAndLaunchFragment callback) {
